//
//  HalfCircleSpinnerWithoutBorder.swift
//  LoadingIndicators
//
...
/**
 * A view that creates a loading indicator in 2 half circular arcs form.
 ...
 */
struct HalfCircleSpinnerWithoutBorder: View {
...
struct HalfCircleSpinnerWithoutBorder_Previews: PreviewProvider {
    static var previews: some View {
        HalfCircleSpinnerWithoutBorder()
    }
}
